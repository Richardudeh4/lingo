    ...
    <div className='flex flex-row-reverse gap-[48px] px-6 '>
      ...
      <Quests points={userProgress.points}/>
            ...
            <FeedWrapper>
                ...
                <Image src="/assets/medal.svg" alt="leaderboard" width={90} height={90}/>
                <h1 className='text-center font-bold text-neutral-800 text-2xl my-6'>
                  Leaderboard 
                </h1>
                <p className='text-muted-foreground text-center text-lg mb-6'>See where you stand among other members in the commmunity</p>
